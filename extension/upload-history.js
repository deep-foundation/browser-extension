...
export const executeUploadHistory = async (history, GQL_URL, GQL_TOKEN, PACKAGE_NAME, CONTAINER_LINK_ID) => {
  const historyData = await prepareHistoryData(history, PACKAGE_NAME, CONTAINER_LINK_ID);
